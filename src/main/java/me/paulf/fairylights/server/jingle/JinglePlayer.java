...
public final class JinglePlayer {
    ...
    private static final class PlayingState extends State<PlayingState> {
        ...
        private final SimpleParticleType[] noteParticle;
        ...
        private PlayingState(final Jingle jingle, final int lightOffset, final List<Jingle.PlayTick> playTicks, final int length, final SimpleParticleType[] noteParticle) {
            this.jingle = jingle;
        ...
        private static SimpleParticleType[] getParticles(final Jingle jingle) {
            if (jingle.getTitle().hashCode() == 0xf2b587de) {
                return new SimpleParticleType[]{ParticleTypes.NOTE, ParticleTypes.LAVA};
            }
            if (jingle.getTitle().hashCode() == 0xc3fa68bd || jingle.getTitle().hashCode() == 0x70f77bf4) {
                return new SimpleParticleType[]{ParticleTypes.NOTE, ParticleTypes.HEART};
            }
            return new SimpleParticleType[]{ParticleTypes.NOTE};
        }
    }
}
