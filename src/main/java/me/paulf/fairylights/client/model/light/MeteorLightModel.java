...
public class MeteorLightModel extends LightModel<MeteorLightBehavior> {
    ...
    public MeteorLightModel() {
        ...
        for (int i = 0; i < lightCount; i++) {
            final BulbBuilder light = bulb.createChild(37, 72, (m, u, v) -> new ModelPart(m, u, v) {
                @Override
                public void translateRotate(final PoseStack stack) {
